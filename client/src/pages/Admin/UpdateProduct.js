...
const UpdateProduct = () => {
    ...
    const [category, setCategory] = useState(null); // Initialize with null or default category object
                        ...
                        <div className="mb-6">
                            ...
                            <div className="mb-3">
                                <button
                                    ...
                                    className="bg-red-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring focus:ring-blue-300"
                                >
                                    DELETE PRODUCT
                                </button>
                            </div>
