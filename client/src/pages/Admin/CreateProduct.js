      ...
      <div className="container-fluid m-3 p-3">
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="w-full sm:w-3/4 ml-0 sm:ml-2">
            ...
            <div className="m-1 w-full sm:w-3/4">
              <div className="mb-3">
              ...
              <div className="mb-3">
                <button
                  ...
                  className="bg-gray-800 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring focus:ring-blue-300"
                >
                  CREATE PRODUCT
                </button>
              </div>
